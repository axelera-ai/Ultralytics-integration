...
!!! tip "First run downloads the SDK automatically"
    ...
    ```bash
    pip install axelera-devkit==1.6.0rc5 --extra-index-url https://software.axelera.ai/artifactory/api/pypi/axelera-pypi/simple
    pip install axelera-rt==1.6.0rc5 --extra-index-url https://software.axelera.ai/artifactory/api/pypi/axelera-pypi/simple
    ```
